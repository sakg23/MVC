...
class DiceGameController extends AbstractController
{
    ...
    #[Route("/game/pig/session/delete", name: "session_delete")]
    public function sessionDelete(SessionInterface $session): Response
    {
        $session->clear();
        $this->addFlash('notice', 'All session data has been deleted!');
        return $this->redirectToRoute('pig_start');
    }
    ...
    public function initCallback(Request $request, SessionInterface $session): Response
    {
        ...
        $this->addFlash('success', 'Game initialized successfully!');
